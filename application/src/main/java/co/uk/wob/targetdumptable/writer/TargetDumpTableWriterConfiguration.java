package co.uk.wob.targetdumptable.writer;
...
@Configuration
public class TargetDumpTableWriterConfiguration {
	...
	@Bean
	public ItemWriter<Person> targetDumpTableItemWriter() {
		csvPath = generateCsvPath();
		return new FlatFileItemWriterBuilder<Person>()
				.name("targetDumpTableItemWriter")
